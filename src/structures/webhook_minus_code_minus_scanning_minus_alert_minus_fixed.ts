 ...
 */
export type webhook_minus_code_minus_scanning_minus_alert_minus_fixed = {
  action: "fixed";
  /**
  ...
  alert: {
     ...
     */
    dismissed_at: (string & tags.Format<"date-time">) | null;
    /**
     * @title User
     */
    dismissed_by: {
     ...
     */
    html_url: string & tags.Format<"uri">;
    instances_url?: string & tags.Format<"uri">;
    /**
