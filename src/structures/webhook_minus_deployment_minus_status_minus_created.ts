 ...
 */
export type webhook_minus_deployment_minus_status_minus_created = {
  action: "created";
  check_run?: {
    ...
    conclusion:
      ...
      | "skipped"
      | null;
    details_url: string & tags.Format<"uri">;
    external_id: string;
    /**
  ...
  deployment_status: {
    ...
    description: string;
    environment: string;
    environment_url?: string & tags.Format<"uri">;
    id: number & tags.Type<"int32">;
    log_url?: string & tags.Format<"uri">;
    node_id: string;
    /**
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     *
