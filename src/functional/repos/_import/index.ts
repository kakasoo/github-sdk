...
export namespace getByOwnerAndRepo {
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/import`;
  export const random = (g?: Partial<typia.IRandomGenerator>): Import =>
    typia.random<Import>(g);
