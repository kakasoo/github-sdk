...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposDependabotSecrets.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/dependabot/secrets`;
...
export namespace getByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposDependabotSecrets.GetHeader;
  export type Output = dependabot_minus_secret;
  ...
  export const path = (owner: string, repo: string, secret_name: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/dependabot/secrets/${encodeURIComponent(secret_name ?? "null")}`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
  ): dependabot_minus_secret => typia.random<dependabot_minus_secret>(g);
  export const simulate = (
    connection: IConnection<getByOwnerAndRepoAndSecret_name.Headers>,
    owner: string,
    repo: string,
...
export namespace putByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposDependabotSecrets.PutHeader;
...
export namespace eraseByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposDependabotSecrets.DeleteHeader;
