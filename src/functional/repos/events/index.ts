...
import { IApiReposEvents } from "../../../structures/IApiReposEvents";
...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposEvents.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/events`;
