...
import { IApiReposIssuesCommentsReactions } from "../../../../../structures/IApiReposIssuesCommentsReactions";
...
export namespace getByOwnerAndRepoAndComment_id {
  export type Headers = IApiReposIssuesCommentsReactions.GetHeader;
  export type Query = IApiReposIssuesCommentsReactions.GetQuery;
  ...
  export const path = (
    ...
    const location: string = `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/issues/comments/${encodeURIComponent(comment_id ?? "null")}/reactions`;
...
export namespace postByOwnerAndRepoAndComment_id {
  export type Headers = IApiReposIssuesCommentsReactions.PostHeader;
  ...
  export const path = (owner: string, repo: string, comment_id: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/issues/comments/${encodeURIComponent(comment_id ?? "null")}/reactions`;
  export const random = (g?: Partial<typia.IRandomGenerator>): reaction =>
    typia.random<reaction>(g);
  export const simulate = (
    connection: IConnection<postByOwnerAndRepoAndComment_id.Headers>,
...
export namespace eraseByOwnerAndRepoAndComment_idAndReaction_id {
  export type Headers = IApiReposIssuesCommentsReactions.DeleteHeader;
  ...
  export const path = (
    ...
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/issues/comments/${encodeURIComponent(comment_id ?? "null")}/reactions/${encodeURIComponent(reaction_id ?? "null")}`;
