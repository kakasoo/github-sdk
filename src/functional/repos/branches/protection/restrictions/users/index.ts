...
import { IApiReposBranchesProtectionRestrictionsUsers } from "../../../../../../structures/IApiReposBranchesProtectionRestrictionsUsers";
...
export namespace getByOwnerAndRepoAndBranch {
  export type Headers = IApiReposBranchesProtectionRestrictionsUsers.GetHeader;
  ...
  export const path = (owner: string, repo: string, branch: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/branches/${encodeURIComponent(branch ?? "null")}/protection/restrictions/users`;
  export const random = (
...
export namespace postByOwnerAndRepoAndBranch {
  export type Headers = IApiReposBranchesProtectionRestrictionsUsers.PostHeader;
...
export namespace putByOwnerAndRepoAndBranch {
  export type Headers = IApiReposBranchesProtectionRestrictionsUsers.PutHeader;
  export type Input = body;
  export type Output = simple_minus_user[];
...
export namespace eraseByOwnerAndRepoAndBranch {
  export type Headers =
    IApiReposBranchesProtectionRestrictionsUsers.DeleteHeader;
  export type Input = body;
  export type Output = simple_minus_user[];
