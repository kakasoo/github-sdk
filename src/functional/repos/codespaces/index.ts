...
export * as permissions_check from "./permissions_check";
...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposCodespaces.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/codespaces`;
...
export namespace postByOwnerAndRepo {
  export type Headers = IApiReposCodespaces.PostHeader;
