...
import { IApiReposCodespacesSecrets } from "../../../../structures/IApiReposCodespacesSecrets";
import { body } from "../../../../structures/body";
import { empty_minus_object } from "../../../../structures/empty_minus_object";
import { repo_minus_codespaces_minus_secret } from "../../../../structures/repo_minus_codespaces_minus_secret";
...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposCodespacesSecrets.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/codespaces/secrets`;
...
export namespace getByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposCodespacesSecrets.GetHeader;
  export type Output = repo_minus_codespaces_minus_secret;
  ...
  export const path = (owner: string, repo: string, secret_name: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/codespaces/secrets/${encodeURIComponent(secret_name ?? "null")}`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
  ): repo_minus_codespaces_minus_secret =>
    typia.random<repo_minus_codespaces_minus_secret>(g);
  export const simulate = (
    connection: IConnection<getByOwnerAndRepoAndSecret_name.Headers>,
    owner: string,
    repo: string,
...
export namespace putByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposCodespacesSecrets.PutHeader;
...
export namespace eraseByOwnerAndRepoAndSecret_name {
  export type Headers = IApiReposCodespacesSecrets.DeleteHeader;
