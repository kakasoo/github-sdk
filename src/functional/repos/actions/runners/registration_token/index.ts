...
import { IApiReposActionsRunnersRegistrationToken } from "../../../../../structures/IApiReposActionsRunnersRegistrationToken";
...
export namespace postByOwnerAndRepo {
  export type Headers = IApiReposActionsRunnersRegistrationToken.PostHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/actions/runners/registration-token`;
  export const random = (
