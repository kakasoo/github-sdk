...
import { IApiReposActionsWorkflowsDisable } from "../../../../../structures/IApiReposActionsWorkflowsDisable";
/**
 * Disable a workflow.
...
export namespace putByOwnerAndRepoAndWorkflow_id {
  export type Headers = IApiReposActionsWorkflowsDisable.PutHeader;
  ...
  export const path = (owner: string, repo: string, workflow_id: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/actions/workflows/${encodeURIComponent(workflow_id ?? "null")}/disable`;
