...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposActionsOrganizationSecrets.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/actions/organization-secrets`;
