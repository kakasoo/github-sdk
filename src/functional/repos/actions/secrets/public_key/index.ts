...
import { IApiReposActionsSecretsPublicKey } from "../../../../../structures/IApiReposActionsSecretsPublicKey";
...
export namespace getByOwnerAndRepo {
  export type Headers = IApiReposActionsSecretsPublicKey.GetHeader;
  ...
  export const path = (owner: string, repo: string) =>
    `/repos/${encodeURIComponent(owner ?? "null")}/${encodeURIComponent(repo ?? "null")}/actions/secrets/public-key`;
  export const random = (
