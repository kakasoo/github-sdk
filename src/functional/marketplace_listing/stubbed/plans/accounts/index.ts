...
import { IApiMarketplaceListingStubbedPlansAccounts } from "../../../../../structures/IApiMarketplaceListingStubbedPlansAccounts";
...
export namespace getByPlan_id {
  export type Headers = IApiMarketplaceListingStubbedPlansAccounts.GetHeader;
  export type Query = IApiMarketplaceListingStubbedPlansAccounts.GetQuery;
  ...
  export const path = (plan_id: string, query: getByPlan_id.Query) => {
    ...
    const location: string = `/marketplace_listing/stubbed/plans/${encodeURIComponent(plan_id ?? "null")}/accounts`;
