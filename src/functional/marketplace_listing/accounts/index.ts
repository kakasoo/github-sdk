...
import { IApiMarketplaceListingAccounts } from "../../../structures/IApiMarketplaceListingAccounts";
...
export namespace getByAccount_id {
  export type Headers = IApiMarketplaceListingAccounts.GetHeader;
  ...
  export const path = (account_id: string) =>
    `/marketplace_listing/accounts/${encodeURIComponent(account_id ?? "null")}`;
  export const random = (
