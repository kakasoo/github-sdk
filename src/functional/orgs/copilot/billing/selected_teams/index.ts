...
import { IApiOrgsCopilotBillingSelectedTeams } from "../../../../../structures/IApiOrgsCopilotBillingSelectedTeams";
...
export namespace postByOrg {
  export type Headers = IApiOrgsCopilotBillingSelectedTeams.PostHeader;
  ...
  export const path = (org: string) =>
    `/orgs/${encodeURIComponent(org ?? "null")}/copilot/billing/selected_teams`;
...
export namespace eraseByOrg {
  export type Headers = IApiOrgsCopilotBillingSelectedTeams.DeleteHeader;
  export type Input = body;
  export type Output = response;
