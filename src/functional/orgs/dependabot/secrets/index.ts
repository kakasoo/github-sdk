...
import { IApiOrgsDependabotSecrets } from "../../../../structures/IApiOrgsDependabotSecrets";
import { body } from "../../../../structures/body";
import { empty_minus_object } from "../../../../structures/empty_minus_object";
import { organization_minus_dependabot_minus_secret } from "../../../../structures/organization_minus_dependabot_minus_secret";
...
export namespace getByOrg {
  export type Headers = IApiOrgsDependabotSecrets.GetHeader;
  ...
  export const path = (org: string) =>
    `/orgs/${encodeURIComponent(org ?? "null")}/dependabot/secrets`;
...
export namespace getByOrgAndSecret_name {
  export type Headers = IApiOrgsDependabotSecrets.GetHeader;
  export type Output = organization_minus_dependabot_minus_secret;
  ...
  export const path = (org: string, secret_name: string) =>
    `/orgs/${encodeURIComponent(org ?? "null")}/dependabot/secrets/${encodeURIComponent(secret_name ?? "null")}`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
  ): organization_minus_dependabot_minus_secret =>
    typia.random<organization_minus_dependabot_minus_secret>(g);
  export const simulate = (
    connection: IConnection<getByOrgAndSecret_name.Headers>,
    org: string,
    secret_name: string,
...
export namespace putByOrgAndSecret_name {
  export type Headers = IApiOrgsDependabotSecrets.PutHeader;
...
export namespace eraseByOrgAndSecret_name {
  export type Headers = IApiOrgsDependabotSecrets.DeleteHeader;
