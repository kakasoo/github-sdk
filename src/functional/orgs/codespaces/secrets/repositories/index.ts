...
import { IApiOrgsCodespacesSecretsRepositories } from "../../../../../structures/IApiOrgsCodespacesSecretsRepositories";
...
export namespace getByOrgAndSecret_name {
  export type Headers = IApiOrgsCodespacesSecretsRepositories.GetHeader;
  ...
  export const path = (org: string, secret_name: string) =>
    `/orgs/${encodeURIComponent(org ?? "null")}/codespaces/secrets/${encodeURIComponent(secret_name ?? "null")}/repositories`;
...
export namespace putByOrgAndSecret_name {
  export type Headers = IApiOrgsCodespacesSecretsRepositories.PutHeader;
...
export namespace putByOrgAndSecret_nameAndRepository_id {
  ...
  export const path = (
    ...
    `/orgs/${encodeURIComponent(org ?? "null")}/codespaces/secrets/${encodeURIComponent(secret_name ?? "null")}/repositories/${encodeURIComponent(repository_id ?? "null")}`;
  export const random = (g?: Partial<typia.IRandomGenerator>): void =>
    typia.random<void>(g);
  export const simulate = (
    connection: IConnection<putByOrgAndSecret_nameAndRepository_id.Headers>,
...
export namespace eraseByOrgAndSecret_nameAndRepository_id {
  export type Headers = IApiOrgsCodespacesSecretsRepositories.DeleteHeader;
