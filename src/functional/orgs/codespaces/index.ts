...
import { IApiOrgsCodespaces } from "../../../structures/IApiOrgsCodespaces";
...
export namespace getByOrg {
  export type Headers = IApiOrgsCodespaces.GetHeader;
  ...
  export const path = (org: string) =>
    `/orgs/${encodeURIComponent(org ?? "null")}/codespaces`;
