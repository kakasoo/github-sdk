...
import { IApiUserIssues } from "../../../structures/IApiUserIssues";
...
export namespace get {
  export type Headers = IApiUserIssues.GetHeader;
  export type Query = IApiUserIssues.GetQuery;
  ...
  export const path = (query: get.Query) => {
    ...
    const location: string = "/user/issues";
