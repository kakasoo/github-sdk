...
export namespace getByAssignment_id {
  export type Headers = IApiAssignmentsAcceptedAssignments.GetHeader;
  export type Output = classroom_minus_accepted_minus_assignment[];
  ...
  export const path = (assignment_id: string) =>
    `/assignments/${encodeURIComponent(assignment_id ?? "null")}/accepted_assignments`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
  ): classroom_minus_accepted_minus_assignment[] =>
    typia.random<classroom_minus_accepted_minus_assignment[]>(g);
